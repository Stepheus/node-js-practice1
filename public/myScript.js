...
function contactAppear(entries, observer4){
    entries.forEach(entry=>{
        ...
        const areaText = document.getElementById("usermessage");
...
document.addEventListener("DOMContentLoaded", ()=>{ 
    ...
    //email contact form
    const contactForm = document.getElementById("contactToEmail");
    ...
    contactForm.addEventListener("submit", (e)=>{
        ...
        const userMail = contactForm.querySelector("#usermail");
        const userPhone = contactForm.querySelector("#userphone");
        const userSubject = contactForm.querySelector("#usersubject");
        const userMessage = contactForm.querySelector("#usermessage");
        ...
        .then(data => {
            ...
            if (data.sent){
                ...
                console.error(data + "response was false");
            }
        })

        .catch(err => console.error("fetch api not posting"))
    })
